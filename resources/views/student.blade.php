		...
		<div class="row tab-content p-0" id="myTabContent">
				...
				<div class="row">
					...
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="m1o1" role="tabpanel" aria-labelledby="m1o1-tab">
							<iframe src="student/selectCourse" class="col-12" frameborder="0" height="800vh"></iframe>
						</div>
						<div class="tab-pane fade" id="m1o2" role="tabpanel" aria-labelledby="m1o2-tab">开发中......</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="m2o1" role="tabpanel" aria-labelledby="m2o1-tab">
							<iframe src="student/selectHomework" class="col-12" frameborder="0" height="800vh"></iframe>
						</div>
			...
			<div class="col-12 tab-pane fade" id="mode3" role="tabpanel" aria-labelledby="mode3-tab">
				<div class="row">
					...
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="m3o1" role="tabpanel" aria-labelledby="m3o1-tab">开发中......</div>
			...
			<div class="col-12 tab-pane fade" id="mode4" role="tabpanel" aria-labelledby="mode4-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="mode4-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m4o1-tab" data-toggle="pill" href="#m4o1" role="tab" aria-controls="m4o1" aria-selected="true">小功能1</a>
						<a class="nav-link text-center" id="m4o2-tab" data-toggle="pill" href="#m4o2" role="tab" aria-controls="m4o2" aria-selected="false">小功能2</a>
					...
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="m4o1" role="tabpanel" aria-labelledby="m3o1-tab">
							<iframe src="student/test" class="col-12" frameborder="0" height="800vh"></iframe>
						</div>
						<div class="tab-pane fade" id="m4o2" role="tabpanel" aria-labelledby="m3o2-tab">开发中......</div>
